export default function Footer() {
  return (
    <footer className="bg-black-900 py-4 tablet-big:py-9 text-center text-white-400 tablet-big:text-s20">
      <div className="my-0 mx-auto min-w-80 flex flex-col gap-y-5 px-5 tablet-big:px-10 tablet-big:flex-row tablet-big:justify-between tablet-big:items-end desktop:items-center desktop:justify-center desktop:gap-x-21">
