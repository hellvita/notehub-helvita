...
export default function Hero() {
  return (
    <div className="relative mb-5 mobile:mb-25 tablet:mb-19 tablet-big:mb-24 desktop:mb-0">
      <h1 className="relative flex flex-col gap-1 mobile:gap-y-45 tablet:gap-y-70 tablet-big:gap-y-93 text-center font-bold mobile:leading-none mobile:text-s60 tablet:text-s104 tablet-big:text-s160 uppercase">
        <span>Welcome</span>
