...
export default function Pagination({
  ...
  return (
    <ReactPaginate
      ...
      containerClassName="flex flex-wrap justify-center items-center gap-3 max-w-56 tablet:max-w-100 tablet-big:max-w-192 mx-auto mobile:text-s20 text-white-950"
